...
- Arma la nueva sección How does Matcha works

- Utiliza CSS Grid para acomodar los elementos en pantalla

- Utiliza las herramientas de la consola de desarrollo de Chrome para encontrar imágenes y colores de esta sección
...
## Juega varios niveles de Grid Garden
